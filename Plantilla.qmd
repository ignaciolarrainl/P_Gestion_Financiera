...
Este modelo lo que hace es que va calculando el precio de manera recursiva de la opción de compra o venta, donde va calculando el precio desde el vencimiento de la opción hasta la fecha actual.
